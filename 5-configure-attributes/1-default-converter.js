/**** 
  LitElement has default converter for the following types:
    - String
    - Number
    - Boolean
    - Array
...
class MyProperties extends LitElement {
  ...
  attributeChangedCallback(name, oldVal, newVal) {
    ...
    // using this.attributeChangedCallback triggers infinite function call
